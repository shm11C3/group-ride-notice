    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div>
            ...
            <br>
            これはスパム・荒らし・サイバー攻撃への対応以外にこのIPアドレスを使用することはありません。加えて、次の各号に掲げる内容を含む投稿作成・ライド参加は以下の禁止行為に該当すると判断した場合承認せず、削除する事があります。<br>
            <br>
            <h5>ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。</h5>
            <br>
